...
const LevelCtrl = (scope,link,swal) => {
...
LevelCtrl.$inject = ['$scope','link.factory','swal.service'];

const LevelComponent =  () => {
	return {
		templateUrl:'views/maintenance/level/level.html',
		css:'views/maintenance/level/level.css',
