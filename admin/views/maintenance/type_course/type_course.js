...
const TypeCourseCtrl = (scope,link,swal) => {
	...
	let model = '\\App\\TypeCourse';

    scope.modelTitle = 'Tipo de Curso';
...
TypeCourseCtrl.$inject = ['$scope','link.factory','swal.service'];

const TypeCourseComponent =  () => {
	return {
		templateUrl:'views/maintenance/type_course/type_course.html',
		css:'views/maintenance/type_course/type_course.css',
		controller: TypeCourseCtrl
	}
}

angular
	.module('app')
	.component('typeCourse',TypeCourseComponent());