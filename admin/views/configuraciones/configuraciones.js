...
const ConfiguracionesCtrl = (scope,link,swal) => {
	...
	let model = '\\App\\Configuracion';

    scope.modelTitle = 'Configuraciones';
...
ConfiguracionesCtrl.$inject = ['$scope','link.factory','swal.service'];

const ConfiguracionesComponent =  () => {
	return {
		templateUrl:'views/configuraciones/configuraciones.html',
		css:'views/configuraciones/configuraciones.css',
...
angular
	.module('app')
	.component('configuraciones',ConfiguracionesComponent());